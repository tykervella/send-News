...
function readAloud() {
    ...
    for (let i = 0; i < read.length; i++) {
      ...
      read[i].addEventListener("click", ()=>{
        ...
        var newsContent="";
        nxtAudioUrl="http://api.voicerss.org/?key=f13b3db346524edc8fdabe0004e11a2f&hl=en-us&c=MP3&f=16khz_16bit_stereo&src="+ contentToRead;
        console.log(nxtAudioUrl, "next");
        console.log(audioUrl,"current");
        if (nxtAudioUrl===audioUrl||audioUrl==="") {
          console.log(newsAudio);
          if (newsAudio.paused) {
            audioUrl="http://api.voicerss.org/?key=f13b3db346524edc8fdabe0004e11a2f&hl=en-us&c=MP3&f=16khz_16bit_stereo&src="+contentToRead;
            currntAudioIndex=i;
